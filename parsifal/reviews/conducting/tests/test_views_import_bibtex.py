...
from parsifal.reviews.conducting.utils import merge_dup_keywords
...
class ImportBibitexTest(TestCase):
    ...
    def test_multiple_import_keywords(self):
        _bibtex_without_dups = merge_dup_keywords(self.new_bibtex_file)
        self.assertEquals(_bibtex_without_dups[12], 'keywords={"Software ecosystems health; Open source ecosystems; Software repository mining"},')
